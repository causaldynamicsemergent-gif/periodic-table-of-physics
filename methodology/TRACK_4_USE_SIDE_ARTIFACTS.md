...
A further example slot remains open. The strongest remaining candidate is the unused **Example B (HK/DUNE/JUNO mass-ordering redundancy)** above — a second, cleaner instance of orthogonal-channel convergence and informative emptiness; the **doubly-orphaned ADE clique** (a structural observation showing the dataset records its own incompleteness) is the other.
